import 'package:firebaseml/redux/counterActions.dart';
import 'package:firebaseml/redux/counterReducer.dart';
import 'package:firebaseml/redux/counterState.dart';
...
class CounterRedux extends StatefulWidget {
  ...
  @override
  _CounterReduxState createState() => _CounterReduxState();
}

class _CounterReduxState extends State<CounterRedux> {
  final store = new Store<CounterState>(counterStatereducer,
